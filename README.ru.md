...
- **Drag & drop атрибутов:** меняйте порядок атрибутов в popup для изменения приоритета

- **Плавающая кнопка-глаз:**
  - Появляется при включении подсветки
...
При включённой подсветке в правом нижнем углу появляется плавающая кнопка:
- **Клик** - включить/выключить подсветку
...
- Редактируемый список атрибутов с возможностью добавления/удаления/сортировки (drag & drop)
